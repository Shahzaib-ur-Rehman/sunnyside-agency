  ...
  return (
    <footer className={`${styles.footer} container`}>
      ...
      <nav className={styles.footerNavigation}>
        <ul role="navigation" className={styles.footerNavigationList}>
          <li className={styles.footerNavigationItem}>
            <a href="" className={styles.footerNavigationItemLink}>
              About
            </a>
          </li>
          <li className={styles.footerNavigationItem}>
      ...
      <ul role="link" className={styles.socialMediaList}>
